package com.linkites.tailorfly.util;
...
public class Utility {
     ...
     public static String GetJSONFromRedBus(String url) {
  		// TODO Auto-generated method stub
  		String result = "";
  		System.out.println("URL comes in jsonparser class is:  " + url);
  		try
  		{
  			...
  			HttpGet httpGet = new HttpGet(url);
  			httpGet.setHeader("key", Constant.RED_BUS_CONSUMER_KEY);
  			httpGet.setHeader("secret", Constant.RED_BUS_CONSUMER_SECRET);
  			HttpResponse httpResponse = httpClient.execute(httpGet);
    ...
    public static String GetDataFromURL(String fileUrl)
    {
    	String response = "";
    	try 
    	{
	...
	//this is simple method to load small images 
	public static Bitmap getSimpleBitmap(String url) {
		Bitmap bm = null;
		try {
			URL aURL = new URL(url);
            URLConnection conn = aURL.openConnection();
